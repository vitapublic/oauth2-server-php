...
interface UserClaimsInterface
{
    ...
    const E_ASSETS_CLAIM_VALUES = 'userid user_pk user_type teamid teamuser_pk membership membership_expires_at active solve_membership_error';
    const D_ASSETS_CLAIM_VALUES = 'userid user_pk user_type teamid teamuser_pk membership membership_expires_at active solve_membership_error';
